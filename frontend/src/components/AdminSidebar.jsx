...
const AdminSidebar = () => {
    ...
    const navItems = [
        ...
        { label: 'Manage Caretakers', icon: MdPeople, link: '###########' },
        { label: 'Manage Devices', icon: MdDevices, link: '###########' },
    ...
    return (
        <div className="w-[240px] h-[92vh] bg-gray-100 shadow-md border-r border-[#34A8DD] flex flex-col justify-between items-center py-5">
