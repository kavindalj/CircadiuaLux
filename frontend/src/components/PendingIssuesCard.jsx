...
const PendingIssuesCard = () => {
  return (
    <div>
      <div className="bg-gradient-to-br from-[#81E5FF] to-[#2197CD] p-6 rounded-[25px] shadow-lg w-[350px] h-[235px] text-left relative">
       
        <p className="text-white text-[29px] mb-2">Pending Issues</p>

        <p className="text-white text-[128px] leading-none">03</p>
...
export default PendingIssuesCard;
